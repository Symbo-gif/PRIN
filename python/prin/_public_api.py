...
RC1_PUBLIC_API: tuple[str, ...] = (
    ...
    "TelemetryLogger",
    # WP-036 S1 sub-pass 0141D2 — net-new Python surface, part 2 (Bucket G
    # remainder): simulation, topology, temporal training, y4q1 tools,
    # hybrid-model family, active-control family, slot-attention adapter.
    "OscilloSim",
    "SimulationResult",
    "quick_simulate",
