...
class PhaseToRateAutoencoderCtx:
    def backward(
        self, grad_recon: object, grad_rates: object
    ) -> object: ...
...
class DenseAutoencoderCtx:
    def backward(
        self, grad_recon: object, grad_codes: object
    ) -> object: ...
...
class DenseAutoencoderBridge:
    ...
    def forward(
        self, x: object
    ) -> tuple[object, object, DenseAutoencoderCtx]: ...
    def classify(
        self, x: object
    ) -> tuple[object, DenseAutoencoderClassifyCtx]: ...
    def load_torch_weights(self, weights: list[object]) -> None: ...
    def state_dict(self) -> bytes: ...
    def load_state_dict(self, state: bytes) -> None: ...
