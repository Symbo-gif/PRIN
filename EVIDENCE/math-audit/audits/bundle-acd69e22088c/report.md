# Audit Evidence Report: bundle-acd69e22088c
...
**Generated:** 2026-09-01T20:00:09.765Z
...
- **Contributing audits:** audit-3f7676801b69
...
- **Contributing audits:** audit-2a8d2363945c
...
- **Contributing audits:** audit-6ee079efbe0c
...
- **Code references:** crates/prin-dynamics/src/coupling.rs:222-263, crates/prin-dynamics/src/coupling.rs:203-220  
- **Reason:** all required checks passed  
- **Contributing audits:** audit-cdac72bd89c4

## Tool invocations

### audit_graph_topology (`audit-3f7676801b69`) -- `PASS`
...
- **Output content hash:** `sha256:c2cde917f6fac6ad7ff857e335ab6e177bdb1128c0d96d7bd5c46dc9288d6382`

### audit_graph_topology (`audit-2a8d2363945c`) -- `PASS`
...
- **Output content hash:** `sha256:b74f38ed58e9437f44030b873a2b565d2eb994613bda2aac68cadf85f9afa30c`

### verify_lean_claim (`audit-6ee079efbe0c`) -- `PASS`
...
**Reasoning:** Ran `C:\Users\there\.elan\bin\lean.EXE C:\dev\PRIN\EVIDENCE\math-audit\scratch\lean\tmpko2qnxh7.lean`. Elaboration succeeded. See lean-diagnostics.txt artifact for full sanitized output.
...
- **Output content hash:** `sha256:f23a4df7a769df92845cd3a9cf6b4a547f982647bd5ed7bcea3df79ff60e1458`

### audit_graph_regularity_sat (`audit-cdac72bd89c4`) -- `PASS`
...
- **Output content hash:** `sha256:d5ae7ad5f528e3c4a7538a844757073776192becbcdfa3395eddee3e2ec6e695`
