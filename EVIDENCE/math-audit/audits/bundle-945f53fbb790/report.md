# Audit Evidence Report: bundle-945f53fbb790
...
**Generated:** 2026-08-26T05:11:09.865Z
...
- **Contributing audits:** audit-80829208cabc
...
- **Contributing audits:** audit-8bef3097844a
...
- **Contributing audits:** audit-1216c13a15c1
...
- **Code references:** crates/prin-dynamics/src/coupling.rs:222-263, crates/prin-dynamics/src/coupling.rs:203-220  
- **Reason:** all required checks passed  
- **Contributing audits:** audit-123b1609c978

## Tool invocations

### audit_graph_topology (`audit-80829208cabc`) -- `PASS`
...
- **Output content hash:** `sha256:fa251026b1ad569f85badb959baad8855aad361c5a5e0ae13595e94b50cf6628`

### audit_graph_topology (`audit-8bef3097844a`) -- `PASS`
...
- **Output content hash:** `sha256:4f599ba1fb799d8d6c50334b21410777ecd3e442e32ee806f7e529d2e83bd93e`

### verify_lean_claim (`audit-1216c13a15c1`) -- `PASS`
...
**Reasoning:** Ran `C:\Users\there\.elan\bin\lean.EXE C:\dev\PRIN\EVIDENCE\math-audit\scratch\lean\tmp44r5r9u0.lean`. Elaboration succeeded. See lean-diagnostics.txt artifact for full sanitized output.
...
- **Output content hash:** `sha256:20c89c1906693210d303b4e3ecb83bcd37545be303cae96ce5e02acb771fd33b`

### audit_graph_regularity_sat (`audit-123b1609c978`) -- `PASS`
...
- **Output content hash:** `sha256:cd472265731285b511f65406a0c314603557f39b05b984897c2e503c80e3a743`
