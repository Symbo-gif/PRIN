# Audit Evidence Report: bundle-71702192e0f9
...
**Generated:** 2026-08-26T05:11:13.467Z
...
- **Contributing audits:** audit-41053d40e0e7
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-da1759af2b65
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-97396bb7ce58
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-15c535fa9089

## Tool invocations

### audit_ode (`audit-41053d40e0e7`) -- `PASS`
...
- **Output content hash:** `sha256:aad9586219c34e1e61a2f0f9d238be1780b88f6032b2d4283cce31a957d1dbbf`

### audit_ode (`audit-da1759af2b65`) -- `PASS`
...
- **Output content hash:** `sha256:b0caa215f09f13ad63ac2d362f24c962511218c26b8419e512f90bc4ed080e4d`

### audit_ode (`audit-97396bb7ce58`) -- `PASS`
...
- **Output content hash:** `sha256:946a5e881e51ab77f0dc2ca4b79981ba1bc8a352352adc5db4836b351ee30a1b`

### audit_ode (`audit-15c535fa9089`) -- `PASS`
...
- **Output content hash:** `sha256:f0942ed57b7d3af992d460754b0403dfe4f49274f082689146fac8bc80416c10`
