# Audit Evidence Report: bundle-be99a6936b2f
...
**Generated:** 2026-09-01T19:52:22.507Z
...
- **Contributing audits:** audit-bcc328a1bcc6
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-cc2ce8c6a241
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-fcb4e0fe7c6a
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-063114241160

## Tool invocations

### audit_ode (`audit-bcc328a1bcc6`) -- `PASS`
...
- **Output content hash:** `sha256:e289071ada79eac9bdbcfd1435ee8a4ec13c8735cde04a5f555d48b1ecd14860`

### audit_ode (`audit-cc2ce8c6a241`) -- `PASS`
...
- **Output content hash:** `sha256:a2a517079efd4e77cfd2ab142671404bbb586fdb21c141054a8d927800b7cac1`

### audit_ode (`audit-fcb4e0fe7c6a`) -- `PASS`
...
- **Output content hash:** `sha256:72e7f4e1001e20dea971cb87979bd4a8e86cbf9c51bf92b35884a39cde7742f3`

### audit_ode (`audit-063114241160`) -- `PASS`
...
- **Output content hash:** `sha256:b0479c5211ffff29a7c901ef9bbaf0657a375cc7aeacff23970697c09beaae9b`
