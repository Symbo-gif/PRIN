# Audit Evidence Report: bundle-e7ec1c86bf7d
...
**Generated:** 2026-09-01T19:52:18.920Z
...
- **Contributing audits:** audit-e2864a591008
...
- **Contributing audits:** audit-ed667df46611
...
- **Contributing audits:** audit-5606f3e16a8d
...
- **Code references:** crates/prin-dynamics/src/coupling.rs:222-263, crates/prin-dynamics/src/coupling.rs:203-220  
- **Reason:** all required checks passed  
- **Contributing audits:** audit-85d6d1c9edc4

## Tool invocations

### audit_graph_topology (`audit-e2864a591008`) -- `PASS`
...
- **Output content hash:** `sha256:10a5b27d80ba1a3577499c4be1d327d2e23fc7a993f3657077b662410e58e488`

### audit_graph_topology (`audit-ed667df46611`) -- `PASS`
...
- **Output content hash:** `sha256:fda520d40dddbf26a3ada249d432eeeb99caf98fbb717ebff7c50c8c455c9832`

### verify_lean_claim (`audit-5606f3e16a8d`) -- `PASS`
...
**Reasoning:** Ran `C:\Users\there\.elan\bin\lean.EXE C:\dev\PRIN\EVIDENCE\math-audit\scratch\lean\tmp27mn63m4.lean`. Elaboration succeeded. See lean-diagnostics.txt artifact for full sanitized output.
...
- **Output content hash:** `sha256:56c46300ac637ad37a0d3b9fa7fceb6e924f159a93f03921eb522aa8986b6c26`

### audit_graph_regularity_sat (`audit-85d6d1c9edc4`) -- `PASS`
...
- **Output content hash:** `sha256:31462a005829b018a8670714b087b1902fd0219642fd014c8ff9d764639c6955`
