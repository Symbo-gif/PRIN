# Audit Evidence Report: bundle-f239d01c4dbf
...
**Generated:** 2026-09-01T19:57:40.288Z
...
- **Contributing audits:** audit-dd47b3da5cc4
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-275ac5d17052
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-6dddfc2f8525
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-5c1380fe7b54

## Tool invocations

### audit_ode (`audit-dd47b3da5cc4`) -- `PASS`
...
- **Output content hash:** `sha256:90c3f2ab1f06ad28a651bb0ab2f2a624dcfb180cb4c5b6e6df0cbbbe9097c6ba`

### audit_ode (`audit-275ac5d17052`) -- `PASS`
...
- **Output content hash:** `sha256:a386f23d08b9a35d4c0e72e073dce0f08617815f026f495e8ab2c012ffc98f1c`

### audit_ode (`audit-6dddfc2f8525`) -- `PASS`
...
- **Output content hash:** `sha256:e7ef37476b3642ae16a85b067f28c12495780f9e71f30c879e727d2d12864483`

### audit_ode (`audit-5c1380fe7b54`) -- `PASS`
...
- **Output content hash:** `sha256:f9d88667cd9a29d55822f74a9dca1b297d83ea84671cc15fc953c5391ecbcc52`
