# Audit Evidence Report: bundle-7edcb6252d65
...
**Generated:** 2026-09-01T19:55:17.663Z
...
- **Contributing audits:** audit-466cae56e496
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-57ee125d1de5
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-f092a9fe9187
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-110e1374414e

## Tool invocations

### audit_ode (`audit-466cae56e496`) -- `PASS`
...
- **Output content hash:** `sha256:a802855ac05efd50af8a97804f6fc7f5c3d5e54b7abe6ff1f2d18ff6dc228932`

### audit_ode (`audit-57ee125d1de5`) -- `PASS`
...
- **Output content hash:** `sha256:2efb5913941b6396220a53dcbb923a8f242cbf9084bb743df333a25c87bd16e3`

### audit_ode (`audit-f092a9fe9187`) -- `PASS`
...
- **Output content hash:** `sha256:b70a95e3d52b67101028196ec6b38f84bfd4ff17f68dda4fc5dfb0624d9a5423`

### audit_ode (`audit-110e1374414e`) -- `PASS`
...
- **Output content hash:** `sha256:31a0b1840f997c559d00fe746718c6ddcc1aa00dc15b84e2757b3691cb45baf4`
