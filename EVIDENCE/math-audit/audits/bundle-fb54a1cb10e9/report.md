# Audit Evidence Report: bundle-fb54a1cb10e9
...
**Generated:** 2026-08-18T03:16:56.527Z
...
- **Contributing audits:** audit-0bc2bdfd479a
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-2dc5585a20e3
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-0cdb5bb9f7e9
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-af68928877fe

## Tool invocations

### audit_ode (`audit-0bc2bdfd479a`) -- `PASS`
...
- **Output content hash:** `sha256:abdc1e04ab21fd21538d1c231b382aceb4c4e066a14b2b2bb89156e9c096db20`

### audit_ode (`audit-2dc5585a20e3`) -- `PASS`
...
- **Output content hash:** `sha256:54cb087b10d7478d3314f951614eec48a5e361dd89aa488297c6d0de00b6479c`

### audit_ode (`audit-0cdb5bb9f7e9`) -- `PASS`
...
- **Output content hash:** `sha256:7d59a4e85ff3ad45f9822cd3ae70477f39a70bfc0b1e3c7718266da483b4b4cc`

### audit_ode (`audit-af68928877fe`) -- `PASS`
...
- **Output content hash:** `sha256:17fc5c455c7b8a85690d2c5cbe57bc571c6f4dc0a3925744cb7ee5e8547edaff`
