...
- **Contributing audits:** audit-8f42f44dcea8
...
- **Contributing audits:** audit-dd6ade823c07
...
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-e9889db3faa1
...
- **Code references:** crates/prin-train/src/scalr.rs:228-232  
- **Reason:** all required checks passed  
- **Contributing audits:** audit-01b367c884d3
...
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-2e8de294bbd4
...
- **Reason:** all required checks passed  
- **Contributing audits:** audit-e6ec2d1a3921
...
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-337ed27648bc
...
- **Code references:** crates/prin-train/src/scalr.rs:228-232  
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-9d172f683ea8
...
- **Code references:** crates/prin-train/src/sync_gd.rs:267-278  
- **Reason:** all required checks passed  
- **Contributing audits:** audit-4ba8e2b2740f
...
- **Reason:** all required checks passed  
- **Contributing audits:** audit-dd7d48bd698f

## Tool invocations

### verify_identity (`audit-8f42f44dcea8`) -- `PASS`
...
- **Output content hash:** `sha256:038b3bbaee0f9e79e9bb310ee356f867434d41b6673a03acc50e027cf0f497fd`

### wolfram_crosscheck (`audit-e012fb467554`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:42278cab636431b174acf3dbd4a8b9074dfd758da312488caecb52c8e4622dca`

### verify_identity (`audit-dd6ade823c07`) -- `PASS`
...
- **Output content hash:** `sha256:44a792bf6a3812060345967347d5c4c6a23bbb38ae66d3564cdc0853e757a2b8`

### wolfram_crosscheck (`audit-ef056b2a4a70`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:de6a4314f74b9ebc03cc71169f5fd6ba0632bb4b9a021d99147d93d215c8631a`

### verify_identity (`audit-e9889db3faa1`) -- `PASS`
...
- **Output content hash:** `sha256:60a9abacf1cb44b8683593162093608a6a7643bb4f04c806eababd58eee14590`

### wolfram_crosscheck (`audit-88dfc216054a`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:f960bdf0081af1de825599bd8e29750c02f8e7113a9edd72674433b9564b2b7a`

### verify_identity (`audit-01b367c884d3`) -- `PASS`
...
- **Output content hash:** `sha256:4d0f798f8a23e543390bdd27068acc104a5cc6b398f2d29a721d865dc614d479`

### wolfram_crosscheck (`audit-f5a14997b06c`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:af296c0b05638385144f10b38d55c6cb421a0c3a557cefc9c4a96a31ef44fa79`

### verify_identity (`audit-2e8de294bbd4`) -- `PASS`
...
- **Output content hash:** `sha256:f491e5a80d7bc7cd59f2a20038d2c659d0f5938a650c108f89e379f260409e4f`

### wolfram_crosscheck (`audit-c7dc1cf0634e`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:73caaebf5af788ed9e0b5fcf1e80529af647349567e7af98af48b903fd7b4463`

### verify_identity (`audit-e6ec2d1a3921`) -- `PASS`
...
- **Output content hash:** `sha256:a85a20c097d4139d09b49065ac795b3939a3838020d9f3cbcfd69689b091a3f0`

### wolfram_crosscheck (`audit-797e3f92232b`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:e434e2fb9bbc21760da8158a00089bf899f63c85bf4e643c60859ad45de61578`

### check_constraint_model (`audit-337ed27648bc`) -- `PASS`
...
- **Output content hash:** `sha256:b8ff752f0b7a71c36947aeb757aecf36f82785dac6e49e94532d65dd9a3cb002`

### check_constraint_model (`audit-9d172f683ea8`) -- `PASS`
...
- **Output content hash:** `sha256:b53225d5950eccd05ff77420aba13de4a871f91912089c7d2365257d96094b71`

### check_constraint_model (`audit-4ba8e2b2740f`) -- `PASS`
...
- **Output content hash:** `sha256:1ab55c9d4cd90ea78ca8a00c4f8513fa386f3b0c002fdbfbc5b7fb3bf741d3cf`

### check_constraint_model (`audit-dd7d48bd698f`) -- `PASS`
...
- **Output content hash:** `sha256:e34ee01e8e8abc9708148b6a189e05364766677bfe3fcb5e175490ba412111b4`
