# Audit Evidence Report: bundle-9a9b6afadb31
...
**Generated:** 2026-08-26T05:07:41.337Z
...
- **Contributing audits:** audit-5e041da52686
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-c218d3a606ba
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-b70e3f4c7e3d
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-3800f47d6e2d

## Tool invocations

### audit_ode (`audit-5e041da52686`) -- `PASS`
...
- **Output content hash:** `sha256:b363a1a192944c16f6bdcfed4155e0188f06ada0329b7d8887921a9f0c25c89d`

### audit_ode (`audit-c218d3a606ba`) -- `PASS`
...
- **Output content hash:** `sha256:0ffdc7f4bf999208aa184cb5f0c5b1cf0fdfbee4203c945f36260289404cfdec`

### audit_ode (`audit-b70e3f4c7e3d`) -- `PASS`
...
- **Output content hash:** `sha256:d5216727915aa3bc8d8543ffa95b852f898ca9bc043f65d46ce262753352da6d`

### audit_ode (`audit-3800f47d6e2d`) -- `PASS`
...
- **Output content hash:** `sha256:005d64705c32f210834793543a33169df29383e8cbd050184d498e7bfa801fb7`
