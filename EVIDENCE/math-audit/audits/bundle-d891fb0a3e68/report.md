# Audit Evidence Report: bundle-d891fb0a3e68
...
**Generated:** 2026-08-26T05:07:40.595Z
...
- **Contributing audits:** audit-68007ecba6e0
...
- **Contributing audits:** audit-bbf13fb4b23f
...
- **Contributing audits:** audit-aae933b6b5a8
...
- **Code references:** crates/prin-dynamics/src/coupling.rs:222-263, crates/prin-dynamics/src/coupling.rs:203-220  
- **Reason:** all required checks passed  
- **Contributing audits:** audit-480631252d5f

## Tool invocations

### audit_graph_topology (`audit-68007ecba6e0`) -- `PASS`
...
- **Output content hash:** `sha256:5c61b6bce97e574331a7f3b8c375005fa8125a98f973389e2490b539a0d66515`

### audit_graph_topology (`audit-bbf13fb4b23f`) -- `PASS`
...
- **Output content hash:** `sha256:56b9c7ba99a37cf5cdc1139bb22ad91d2384107cf934f150a6289ba9174a2dea`

### verify_lean_claim (`audit-aae933b6b5a8`) -- `PASS`
...
**Reasoning:** Ran `C:\Users\there\.elan\bin\lean.EXE C:\dev\PRIN\EVIDENCE\math-audit\scratch\lean\tmpqut0zamx.lean`. Elaboration succeeded. See lean-diagnostics.txt artifact for full sanitized output.
...
- **Output content hash:** `sha256:4369aefbc6dda0216c05dc15612347ae9ede08af9316f59b874fc47cf243781e`

### audit_graph_regularity_sat (`audit-480631252d5f`) -- `PASS`
...
- **Output content hash:** `sha256:918e6e0ed6250cdaafcb2d2a1579c1636be5e90caf0db3f9cebb07bead19a487`
