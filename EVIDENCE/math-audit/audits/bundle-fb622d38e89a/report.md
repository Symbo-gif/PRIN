# Audit Evidence Report: bundle-fb622d38e89a
...
**Generated:** 2026-08-15T02:30:08.286Z
...
- **Contributing audits:** audit-dc203cdd2254
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-589a510104b9
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-a01ac10ab76a
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-c5852162a143

## Tool invocations

### audit_ode (`audit-dc203cdd2254`) -- `PASS`
...
- **Output content hash:** `sha256:2b00af7ea0262ef0c64253f69a15fd9a9c3825c62383a940d9037d840cfc1064`

### audit_ode (`audit-589a510104b9`) -- `PASS`
...
- **Output content hash:** `sha256:173cd793144addd4dd4c9fac474e9e8c105d273396ea9dd1332dee33b544e579`

### audit_ode (`audit-a01ac10ab76a`) -- `PASS`
...
- **Output content hash:** `sha256:370b0a9f9e0b0f0a15c699b95a8961d616555e28baa5bd3b84d00cde4f19a419`

### audit_ode (`audit-c5852162a143`) -- `PASS`
...
- **Output content hash:** `sha256:9a2e1eae91d8f52159499ef1e3cfb03978c3e393c9d13353a1bd074795bac654`
