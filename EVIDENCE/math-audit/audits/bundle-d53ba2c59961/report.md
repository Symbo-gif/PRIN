# Audit Evidence Report: bundle-d53ba2c59961
...
**Generated:** 2026-08-26T05:06:04.958Z
...
- **Contributing audits:** audit-c11ee0c39a34
...
- **Contributing audits:** audit-3b5ad0da469e
...
- **Contributing audits:** audit-522deeb27b5c
...
- **Code references:** crates/prin-dynamics/src/coupling.rs:222-263, crates/prin-dynamics/src/coupling.rs:203-220  
- **Reason:** all required checks passed  
- **Contributing audits:** audit-13ddf5dbe5a5

## Tool invocations

### audit_graph_topology (`audit-c11ee0c39a34`) -- `PASS`
...
- algebraic_connectivity: 3.9999999999999987

- **Random seed:** n/a
- **Input content hash:** `sha256:5c40abf3df2a3892a6b1a8b048d78b38bba3bd8616aa02da864474bd1182de8c`
- **Output content hash:** `sha256:beb26d5df9e011ea327ca9551ee07edb8397382526f83798840b7829def93c12`

### audit_graph_topology (`audit-3b5ad0da469e`) -- `PASS`
...
- **Output content hash:** `sha256:86948449fd7264e7572b93f1bd48a8716eecabde72f0652d94105237bc59fc94`

### verify_lean_claim (`audit-522deeb27b5c`) -- `PASS`
...
**Reasoning:** Ran `C:\Users\there\.elan\bin\lean.EXE C:\dev\PRIN\EVIDENCE\math-audit\scratch\lean\tmpbivbgbdw.lean`. Elaboration succeeded. See lean-diagnostics.txt artifact for full sanitized output.
...
- **Output content hash:** `sha256:a583620ee4fac86c748e1390aff68ffe68beb5dc5d3f9c24cc65d93edbde5854`

### audit_graph_regularity_sat (`audit-13ddf5dbe5a5`) -- `PASS`
...
- **Output content hash:** `sha256:f81bb9f93a60d598f9162543795d85e664d0a0fcdfa7680ddbc6354d26184cc1`
