# Audit Evidence Report: bundle-9959a6a5614f
...
**Generated:** 2026-08-14T23:45:44.293Z
...
- **Contributing audits:** audit-8c31208c40ea
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-78afc0782c3e
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-513a5a4d700c
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-0a52c1c95c0b

## Tool invocations

### audit_ode (`audit-8c31208c40ea`) -- `PASS`
...
- **Output content hash:** `sha256:50da98762ebe738fd90a2bdf3fdf0b23dea176c870e4bec0705d737562cc34d9`

### audit_ode (`audit-78afc0782c3e`) -- `PASS`
...
- **Output content hash:** `sha256:07ab7707ec9cd07664cc8c05b9790d9beaa36c26b806832f9d0a4a3ef339807d`

### audit_ode (`audit-513a5a4d700c`) -- `PASS`
...
- **Output content hash:** `sha256:e71bca9fb6fa89c7a001e2f9e7559a849a911f87cf514bc4a0ae9b0cfaac3f53`

### audit_ode (`audit-0a52c1c95c0b`) -- `PASS`
...
- **Output content hash:** `sha256:bcef668c336aa60b4f9a31a71ca4b3dcc4c4fe58ee5804a12075f74e4533743f`
