...
- **Contributing audits:** audit-5f14dade54dc
...
- **Code references:** crates/prin-dynamics/src/state.rs:284-291, crates/prin-dynamics/src/integrate.rs:26-31  
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-072c49c9d878
...
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-9f0444966e4d
...
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-c655e87e7df8
...
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-9aa10f568098
...
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-c3338e942ce5
...
- **Reason:** all required checks passed (formal/symbolic corroboration present)  
- **Contributing audits:** audit-5d61ec394c1a
...
- **Contributing audits:** audit-df60e1b72044

## Tool invocations

### verify_identity (`audit-5f14dade54dc`) -- `PASS`
...
- **Output content hash:** `sha256:907a51c83e1aa6bebdf5c9c3673f80d9fccf8e6eae07b7cb3f41001acaf83cdb`

### wolfram_crosscheck (`audit-d013a3d91c71`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:07d84b7cf5b0cf201284a2bf4fda5f4bc4d33f294b1ac3c19085b1ebc16de820`

### verify_identity (`audit-072c49c9d878`) -- `PASS`
...
- **Output content hash:** `sha256:7e11d48d446befc490a10ca8ca99466208b14a405bec2096991d944cd004ae9b`

### wolfram_crosscheck (`audit-ec2bd75b1f96`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:676a8ab9a504c1034873f829a83f8416b60ad7b33e6f57193012da1f43f78377`

### verify_identity (`audit-9f0444966e4d`) -- `PASS`
...
- **Output content hash:** `sha256:581036ea8c9fe44a1154f1435e0a3ceb434d6c4733105154fc018ace1a0e4481`

### wolfram_crosscheck (`audit-d73e01c12d6d`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:d5ac53cad996c15e827ab3e312596738101ba0b28ed526147d9fa771ce5a2971`

### verify_identity (`audit-c655e87e7df8`) -- `PASS`
...
- **Output content hash:** `sha256:1b59af40a6e789f3a91caac4540294e667aa553a3a2c73048216df8a5d19158a`

### wolfram_crosscheck (`audit-7cc9aa42f16e`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:b5053be33a83b9a46dc6635829c4d0171ed7e06987ae7d3239520b24c992acb7`

### verify_identity (`audit-9aa10f568098`) -- `PASS`
...
- **Output content hash:** `sha256:b87c0a54ed1d726c4f16655a6535efc218277721d6bf1ee4502dac8380c0d424`

### wolfram_crosscheck (`audit-c171333c79eb`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:045acdc3065c1ce20c0c91a30a7c95401a015a713633b92f4e5fa1dd770fe22d`

### verify_identity (`audit-c3338e942ce5`) -- `PASS`
...
- **Output content hash:** `sha256:de70e9ffaf6bb0c42594782920665602e73371db54c1257afe6e046b4912bd0a`

### wolfram_crosscheck (`audit-5f6a8439ec47`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:536da2f4824690809103317ef4838e9b894e43b4b1057e63987cfe5d20b69f42`

### verify_identity (`audit-5d61ec394c1a`) -- `PASS`
...
- **Output content hash:** `sha256:cd4c5f2123211e8245fe75e038bf047ee9ce1e520cf48fb5d71a2b444427ba7e`

### wolfram_crosscheck (`audit-0f24b26acb82`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:e93b774799aeec89aae05338d765dfc5dbfef0ce2f880d8407619cf7f6d50380`

### verify_identity (`audit-df60e1b72044`) -- `PASS`
...
- **Output content hash:** `sha256:88ad90ab3efc72ea141786f5a47de69227f58122ddf3bdf3ab3ef101571f3995`

### wolfram_crosscheck (`audit-89619f4d0dc8`) -- `SKIPPED_BY_POLICY`
...
- **Output content hash:** `sha256:45970c89122ad446b6c5a0ef158f71e46054f83c3dc480c00b3164c6666e92ec`
