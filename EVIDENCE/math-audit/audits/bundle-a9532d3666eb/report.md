# Audit Evidence Report: bundle-a9532d3666eb
...
**Generated:** 2026-08-26T05:06:26.662Z
...
- **Contributing audits:** audit-f9e3e031ae86
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-e1811d9ef60c
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-30c201ef5d93
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-7823aa61ba17

## Tool invocations

### audit_ode (`audit-f9e3e031ae86`) -- `PASS`
...
- **Output content hash:** `sha256:8a6f68ef9da77adfc1e62d091095f8f03c4d1eed81d5d488be13b74ec86561b5`

### audit_ode (`audit-e1811d9ef60c`) -- `PASS`
...
- **Output content hash:** `sha256:2816c5c47a1688f753180003d33c0d1ea4c4f09525cbbfaef7cdd132c1fe0cb3`

### audit_ode (`audit-30c201ef5d93`) -- `PASS`
...
- **Output content hash:** `sha256:2f26bb7e063bbe388248e6a4fad6d3515b9b5bff6371f2cb7776391b07d5d113`

### audit_ode (`audit-7823aa61ba17`) -- `PASS`
...
- **Output content hash:** `sha256:472f8c28acefe4b3e3b35e1cfc146d9291fa13365e7c602cfc60d609d90e8534`
