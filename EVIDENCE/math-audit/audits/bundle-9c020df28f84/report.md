# Audit Evidence Report: bundle-9c020df28f84
...
**Generated:** 2026-08-20T04:30:47.639Z
...
- **Contributing audits:** audit-35cfd6bdcd77
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-d592f35c5abd
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-de902b638b6c
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-95ac171efb80

## Tool invocations

### audit_ode (`audit-35cfd6bdcd77`) -- `PASS`
...
- **Output content hash:** `sha256:f2b56f29a8ed524530fec7ebb4ac73a5064f6f4e44105d11afb8ef7913760b96`

### audit_ode (`audit-d592f35c5abd`) -- `PASS`
...
- **Output content hash:** `sha256:8d1caea508454dedd09cf6d793f624c995ba57a5833628a187decb1b656e271b`

### audit_ode (`audit-de902b638b6c`) -- `PASS`
...
- **Output content hash:** `sha256:ad666771c910c60699f701cd17581b9e80ee5e8ab808c7c7078d4b92a0e5c14f`

### audit_ode (`audit-95ac171efb80`) -- `PASS`
...
- **Output content hash:** `sha256:28ede7f733d84327ee695e903b6b0718fc5bd15e7d8e3b974093df61cfd9bf54`
