# Audit Evidence Report: bundle-b29c307618f4
...
**Generated:** 2026-08-20T02:40:26.124Z
...
- **Contributing audits:** audit-e7f43e93d563
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-82225facb68f
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-3e9051608cae
...
- **Reason:** high/critical-severity claim passed only numerically; policy requires symbolic or formal (SymPy/Z3/Lean) corroboration before a PASS verdict  
- **Contributing audits:** audit-b6c58903c634

## Tool invocations

### audit_ode (`audit-e7f43e93d563`) -- `PASS`
...
- **Output content hash:** `sha256:5b3fed543347cc6a62f49e848cd1a90fad36f310542572deb8ecac3b980e3176`

### audit_ode (`audit-82225facb68f`) -- `PASS`
...
- **Output content hash:** `sha256:acdf2c0880163c51ce9e20d02b0d9b0d375792519db1b8115e8c6dd45533cb1f`

### audit_ode (`audit-3e9051608cae`) -- `PASS`
...
- **Output content hash:** `sha256:2918e04243ab9e3dc6274194c32779c53265b6f05f8311c47117789d543c4e8b`

### audit_ode (`audit-b6c58903c634`) -- `PASS`
...
- **Output content hash:** `sha256:7e805ed5968534a9685194f122ae9c3939e0735034913adfa5460c5adb29121d`
