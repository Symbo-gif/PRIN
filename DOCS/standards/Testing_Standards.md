...
| Metrics / tensor decompositions (float64) | `rtol=1e-8` for cross-platform corpus-regeneration comparisons (amendment #16); single-runtime verification targets `rtol=1e-10` where achievable |
