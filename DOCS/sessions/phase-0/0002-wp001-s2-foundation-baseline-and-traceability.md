...
**Predecessor:** [0001 — Coding](0001-wp001-s1-foundation-baseline-and-traceability.md)  
**Successor:** [0003 — Remediation](0003-wp001-s3-foundation-baseline-and-traceability.md)  
...
1. Create `DOCS/audits/001-wp001-audit.md` from the audit template.
...
3. Independently reproduce the WP-specific acceptance evidence: Baseline automation is tested; every 3.0 module/public symbol has an assigned future WP; scaffold, CI, packaging, and governance gaps are recorded without implementing numerics.
...
5. Give each finding `WP001-Fn`, severity D1–D4, exact evidence,
   violated clause, and proposed remedy. Assign PASS / PASS-WITH-FINDINGS / FAIL.

## Required outputs

- Committed evidence-backed Audit Report at `DOCS/audits/001-wp001-audit.md`.
