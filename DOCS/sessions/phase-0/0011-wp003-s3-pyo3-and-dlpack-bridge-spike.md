...
**Predecessor:** [0010 — Audit](0010-wp003-s2-pyo3-and-dlpack-bridge-spike.md)  
**Successor:** [0012 — Documentation](0012-wp003-s4-pyo3-and-dlpack-bridge-spike.md)  
...
- `DOCS/audits/003-wp003-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/003-wp003-audit.md` with FIXED / AMENDED / permitted
