...
- `DOCS/audits/024-wp024-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/024-wp024-audit.md` with FIXED / AMENDED / permitted
