...
**Predecessor:** [0106 — Audit](0106-wp027-s2-trainable-stack-integration-and-phase-4-gate.md)  
**Successor:** [0108 — Documentation](0108-wp027-s4-trainable-stack-integration-and-phase-4-gate.md)  
...
- `DOCS/audits/027-wp027-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/027-wp027-audit.md` with FIXED / AMENDED / permitted
