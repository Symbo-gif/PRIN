...
**Predecessor:** [0058 — Audit](0058-wp015-s2-oscillosim-sparse-simulation-engine.md)  
**Successor:** [0060 — Documentation](0060-wp015-s4-oscillosim-sparse-simulation-engine.md)  
...
- `DOCS/audits/015-wp015-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/015-wp015-audit.md` with FIXED / AMENDED / permitted
