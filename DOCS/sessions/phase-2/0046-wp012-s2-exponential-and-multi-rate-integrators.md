...
**Predecessor:** [0045 — Coding](0045-wp012-s1-exponential-and-multi-rate-integrators.md)  
**Successor:** [0047 — Remediation](0047-wp012-s3-exponential-and-multi-rate-integrators.md)  
...
Implement direct/Krylov exponential integration, phi1 limit handling, and multi-rate scheduling.

## Contract

- **Acceptance:** Golden and convergence tests pass, including lambda→0; stability and typed failure cases are demonstrated.
- **Non-goals:** Network orchestration or GPU acceleration.
...
1. Create `DOCS/audits/012-wp012-audit.md` from the audit template.
...
3. Independently reproduce the WP-specific acceptance evidence: Golden and convergence tests pass, including lambda→0; stability and typed failure cases are demonstrated.
...
5. Give each finding `WP012-Fn`, severity D1–D4, exact evidence,
   violated clause, and proposed remedy. Assign PASS / PASS-WITH-FINDINGS / FAIL.

## Required outputs

- Committed evidence-backed Audit Report at `DOCS/audits/012-wp012-audit.md`.
