...
**Predecessor:** [0046 — Audit](0046-wp012-s2-exponential-and-multi-rate-integrators.md)  
**Successor:** [0048 — Documentation](0048-wp012-s4-exponential-and-multi-rate-integrators.md)  
...
- `DOCS/audits/012-wp012-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/012-wp012-audit.md` with FIXED / AMENDED / permitted
