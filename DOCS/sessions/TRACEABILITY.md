...
| **F5 — CPU/DirectML/Ryzen AI controller** | WP-005 probe (0017–0020); WP-028–029 (0109–0116); WP-036F DirectML controller-graph execution (`0144U`–`0144X`, amdt #38 — closes the DirectML half of DV-006) | EXP-007–008 (0184–0193); WP-039 audit |
...
| Device-event GPU timing / host dispatch dominance (DV-003) | WP-018 (0069–0072); **partially** closed by WP-036E on-device CUDA `f64` combine + bounded host residual (`0144Q2`; amdt #38/#43); genuine CUDA device-event timing re-gated to a CubeCL `TimingMethod::Device` CUDA release (`0144S`, amdt #44) | EXP-004 |
...
|---:|---|---|
| R1 CubeCL misses Triton | WP-004 (0013–0016) | WP-021 gate; WP-036E device-resident GPU path (`0144Q`–`0144T`) partially closes DV-003 (amdt #44) and DV-030 (amdt #43); WP-036G records DV-001's standing external disposition + dormant `gpu-triton.yml` (`0144Y`–`0144AB`); EXP-004; amendment/fallback correction cycle |
...
| 7. Controller providers | WP-036F DirectML controller-graph execution (`0144U`–`0144X`); EXP-007/008; 0196 |
...
| 11. Complete audit/state trail | all S2/S4; WP-036G Deferred-Validation register consolidation and permanent dispositions + Phase 7 entry statement (`0144Y`–`0144AB`, amdt #38); 0196 |
...
1. Exactly 39 integer-numbered WPs exist (WP-001…WP-039), each with exactly
   one ordered S1/S2/S3/S4 brief, plus the amendment-inserted WP-036
   alphabetic-sibling family — WP-036A (amdt #33), WP-036B / WP-036C (amdt
   #31), WP-036D (amdt #36), and WP-036E / WP-036F / WP-036G (amdt #38) —
   each also with exactly one ordered S1/S2/S3/S4 brief. Sibling WPs do not
   consume integer WP numbers and their audits/PSRs are numbered `036a`…`036g`.
...
4. Global sequence is unique and gap-free from 0001 through 0198. Amendment
   ...
   S1 decomposition), amendment #36 (WP-036D at `0144I`–`0144L` incl.
