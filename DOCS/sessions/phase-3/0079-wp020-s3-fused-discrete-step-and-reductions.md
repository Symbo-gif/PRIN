...
**Predecessor:** [0078 — Audit](0078-wp020-s2-fused-discrete-step-and-reductions.md)  
**Successor:** [0080 — Documentation](0080-wp020-s4-fused-discrete-step-and-reductions.md)  
...
- `DOCS/audits/020-wp020-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/020-wp020-audit.md` with FIXED / AMENDED / permitted
