...
| 0158 | EXP-001 | E5 — Report | [Golden-trajectory numerical parity](0158-exp001-e5-golden-trajectory-numerical-parity.md) | PLANNED — completes and reports the negatives in full, then **blocks 0159** and every downstream experiment (§10.4 item 2, §3.3) |
