...
**Predecessor:** [0134 — Audit](0134-wp034-s2-reporting-figures-tables-and-profiling.md)  
**Successor:** [0136 — Documentation](0136-wp034-s4-reporting-figures-tables-and-profiling.md)  
...
- `DOCS/audits/034-wp034-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/034-wp034-audit.md` with FIXED / AMENDED / permitted
