...
| 0141 | WP-036 | S1 — Coding | [API completion, acceptance suite, and migration](0141-wp036-s1-api-completion-acceptance-suite-and-migration.md) | COMPLETE (decomposed into 0141A–0141E) |
...
| 0144E | WP-036B | S1 — Coding | [Acceptance suite port — core, dynamics, model stack, subconscious](0144E-wp036b-s1-acceptance-suite-port-core-dynamics-model-stack.md) | COMPLETE (decomposed into 0144E1–0144E6) |
...
| 0144H | WP-036B | S4 — Documentation | [Acceptance suite port — core, dynamics, model stack, subconscious](0144H-wp036b-s4-acceptance-suite-port-core-dynamics-model-stack.md) | COMPLETE — WP-036B closed |
| 0144I | WP-036D | S1 — Coding | [GPU execution path for the ported acceptance suite](0144I-wp036d-s1-gpu-execution-path-ported-acceptance-suite.md) | COMPLETE (sub-passes 0144I1–0144I3) |
| 0144I1 | WP-036D | S1 — Coding | [PyO3 GPU binding layer](0144I1-wp036d-s1-pyo3-gpu-binding-layer.md) | COMPLETE |
| 0144I2 | WP-036D | S1 — Coding | [Python device dispatch and DLPack marshalling](0144I2-wp036d-s1-device-dispatch-and-dlpack-marshalling.md) | COMPLETE |
| 0144I3 | WP-036D | S1 — Coding | [GPU test activation, CI, and consolidation](0144I3-wp036d-s1-gpu-test-activation-and-ci.md) | COMPLETE |
...
| 0144K | WP-036D | S3 — Remediation | [GPU execution path for the ported acceptance suite](0144K-wp036d-s3-gpu-execution-path-ported-acceptance-suite.md) | COMPLETE |
| 0144L | WP-036D | S4 — Documentation | [GPU execution path for the ported acceptance suite](0144L-wp036d-s4-gpu-execution-path-ported-acceptance-suite.md) | COMPLETE — WP-036D closed |
| 0144M | WP-036C | S1 — Coding | [Acceptance suite port — integration, y-series, kernels; DV-025](0144M-wp036c-s1-acceptance-suite-port-integration-y-series-kernels.md) | COMPLETE (decomposed into 0144M1–0144M8) |
...
| 0144P | WP-036C | S4 — Documentation | [Acceptance suite port — integration, y-series, kernels; DV-025](0144P-wp036c-s4-acceptance-suite-port-integration-y-series-kernels.md) | COMPLETE — WP-036C closed |
| 0144Q | WP-036E | S1 — Coding | [GPU device-resident execution path](0144Q-wp036e-s1-gpu-device-resident-execution-path.md) | COMPLETE (decomposed into `0144Q1`–`0144Q3`, re-scoped — amendment #43) |
...
| 0144X | WP-036F | S4 — Documentation | [DirectML controller-graph execution](0144X-wp036f-s4-directml-controller-graph-execution.md) | COMPLETE — WP-036F closed; DV-006 DirectML half CLOSED |
| 0144Y | WP-036G | S1 — Coding | [Deferred-Validation register consolidation and permanent dispositions](0144Y-wp036g-s1-dv-register-consolidation-and-permanent-dispositions.md) | COMPLETE — dispositions drafted; DV-035 registered; fragility resolved |
| 0144Z | WP-036G | S2 — Audit | [Deferred-Validation register consolidation and permanent dispositions](0144Z-wp036g-s2-dv-register-consolidation-and-permanent-dispositions.md) | COMPLETE — PASS (zero findings) |
| 0144AA | WP-036G | S3 — Remediation | [Deferred-Validation register consolidation and permanent dispositions](0144AA-wp036g-s3-dv-register-consolidation-and-permanent-dispositions.md) | COMPLETE — mandatory no-change closure, delta re-audit CLEAN |
...
| 0148 | WP-037 | S4 — Documentation | [Documentation, notebooks, paper, and Parity Report draft](0148-wp037-s4-documentation-notebooks-paper-and-parity-report-draft.md) | COMPLETE — WP-037 closed locally; PSR-037 issued; WP037-F6 carried to governed push/remote-CI gate; WP-038 declared |
| 0149 | WP-038 | S1 — Coding | [RC1 packaging and Phase 6 gate](0149-wp038-s1-rc1-packaging-and-phase-6-gate.md) | COMPLETE — version bump, tag, DV-010 partial closure |
| 0150 | WP-038 | S2 — Audit | [RC1 packaging and Phase 6 gate](0150-wp038-s2-rc1-packaging-and-phase-6-gate.md) | COMPLETE — PASS-WITH-FINDINGS (WP038-F1/F2 D2) |
| 0151 | WP-038 | S3 — Remediation | [RC1 packaging and Phase 6 gate](0151-wp038-s3-rc1-packaging-and-phase-6-gate.md) | COMPLETE — F1–F3 FIXED, F4–F6 AMENDED (amdt #46, DV-037); delta CLEAN; publication COMPLETED |
| 0152 | WP-038 | S4 — Documentation | [RC1 packaging and Phase 6 gate](0152-wp038-s4-rc1-packaging-and-phase-6-gate.md) | COMPLETE — Phase 6 complete; DV-010 CLOSED; `v1.0.0-rc1` published |
