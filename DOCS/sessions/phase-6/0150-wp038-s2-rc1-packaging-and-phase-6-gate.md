...
**Predecessor:** [0149 — Coding](0149-wp038-s1-rc1-packaging-and-phase-6-gate.md)  
**Successor:** [0151 — Remediation](0151-wp038-s3-rc1-packaging-and-phase-6-gate.md)  
...
1. Create `DOCS/audits/038-wp038-audit.md` from the audit template.
...
3. Independently reproduce the WP-specific acceptance evidence: No-compiler installs pass across OS families; all CI/security/repro gates green; RC1 artefacts and checksums published; Phase 7 entry criteria satisfied.
...
5. Give each finding `WP038-Fn`, severity D1–D4, exact evidence,
   violated clause, and proposed remedy. Assign PASS / PASS-WITH-FINDINGS / FAIL.

## Required outputs

- Committed evidence-backed Audit Report at `DOCS/audits/038-wp038-audit.md`.
