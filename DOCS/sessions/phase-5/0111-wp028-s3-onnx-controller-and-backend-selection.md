...
**Predecessor:** [0110 — Audit](0110-wp028-s2-onnx-controller-and-backend-selection.md)  
**Successor:** [0112 — Documentation](0112-wp028-s4-onnx-controller-and-backend-selection.md)  
...
- `DOCS/audits/028-wp028-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/028-wp028-audit.md` with FIXED / AMENDED / permitted
