...
**Predecessor:** [0118 — Audit](0118-wp030-s2-training-hooks-and-mot-evaluation.md)  
**Successor:** [0120 — Documentation](0120-wp030-s4-training-hooks-and-mot-evaluation.md)  
...
- `DOCS/audits/030-wp030-audit.md` and every cited violated clause
...
5. Append the closure table to `DOCS/audits/030-wp030-audit.md` with FIXED / AMENDED / permitted
