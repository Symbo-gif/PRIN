...
**Predecessor:** [0033 — Coding](0033-wp009-s1-pac-coupling-topologies-and-phase-k-nn.md)  
**Successor:** [0035 — Remediation](0035-wp009-s3-pac-coupling-topologies-and-phase-k-nn.md)  
...
1. Create `DOCS/audits/009-wp009-audit.md` from the audit template.
...
3. Independently reproduce the WP-specific acceptance evidence: Golden parity covers all modes; 1/N versus 1/k is explicit; sparse/full equivalence and k-NN edge properties pass.
...
5. Give each finding `WP009-Fn`, severity D1–D4, exact evidence,
   violated clause, and proposed remedy. Assign PASS / PASS-WITH-FINDINGS / FAIL.

## Required outputs

- Committed evidence-backed Audit Report at `DOCS/audits/009-wp009-audit.md`.
