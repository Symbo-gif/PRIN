# Phase 1 sessions — Dynamics core
...
| 0031 | WP-008 | S3 — Remediation | [Basic integrators](0031-wp008-s3-basic-integrators.md) | COMPLETE |
| 0032 | WP-008 | S4 — Documentation | [Basic integrators](0032-wp008-s4-basic-integrators.md) | COMPLETE |
...
| 0034 | WP-009 | S2 — Audit | [PAC, coupling topologies, and phase k-NN](0034-wp009-s2-pac-coupling-topologies-and-phase-k-nn.md) | PLANNED |
| 0035 | WP-009 | S3 — Remediation | [PAC, coupling topologies, and phase k-NN](0035-wp009-s3-pac-coupling-topologies-and-phase-k-nn.md) | PLANNED |
| 0036 | WP-009 | S4 — Documentation | [PAC, coupling topologies, and phase k-NN](0036-wp009-s4-pac-coupling-topologies-and-phase-k-nn.md) | PLANNED |
| 0037 | WP-010 | S1 — Coding | [Phase metrics and chimera measures](0037-wp010-s1-phase-metrics-and-chimera-measures.md) | PLANNED |
