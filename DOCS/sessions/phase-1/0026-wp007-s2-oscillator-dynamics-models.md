...
**Predecessor:** [0025 — Coding](0025-wp007-s1-oscillator-dynamics-models.md)  
**Successor:** [0027 — Remediation](0027-wp007-s3-oscillator-dynamics-models.md)  
...
Implement the Dynamics trait and Kuramoto, Stuart–Landau, and Hopf models with enum-based coupling semantics.

## Contract

- **Acceptance:** Float64 golden cases and generated invariants pass for each model and edge regime; APIs are fully documented and typed.
- **Non-goals:** Time integration and topology construction.
...
1. Create `DOCS/audits/007-wp007-audit.md` from the audit template.
...
3. Independently reproduce the WP-specific acceptance evidence: Float64 golden cases and generated invariants pass for each model and edge regime; APIs are fully documented and typed.
...
5. Give each finding `WP007-Fn`, severity D1–D4, exact evidence,
   violated clause, and proposed remedy. Assign PASS / PASS-WITH-FINDINGS / FAIL.

## Required outputs

- Committed evidence-backed Audit Report at `DOCS/audits/007-wp007-audit.md`.
