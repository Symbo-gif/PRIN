# benchmarks/results/EXP-007/ — raw artefacts for EXP-007 (Daemon, MOT, and adversarial replication)

**Status:** SKELETON — no run has executed. Record root:
[`DOCS/experiments/EXP-007-daemon-mot-and-adversarial-replication/`](../../../DOCS/experiments/EXP-007-daemon-mot-and-adversarial-replication/README.md).
...
`python -m benchmarks.benchrunner … --out benchmarks/results/EXP-007/RUN-…/`
...
run = Path("benchmarks/results/EXP-007/RUN-...")
...
run; larger arrays go to the gitignored `DOCS/test_and_benchmark_results/EXP-007/`
