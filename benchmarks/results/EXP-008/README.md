# benchmarks/results/EXP-008/ — raw artefacts for EXP-008 (Cross-platform and new-capability characterization)

**Status:** SKELETON — no run has executed. Record root:
[`DOCS/experiments/EXP-008-cross-platform-and-new-capability-characterization/`](../../../DOCS/experiments/EXP-008-cross-platform-and-new-capability-characterization/README.md).
...
`python -m benchmarks.benchrunner … --out benchmarks/results/EXP-008/RUN-…/`
...
run; larger arrays go to the gitignored `DOCS/test_and_benchmark_results/EXP-008/`
