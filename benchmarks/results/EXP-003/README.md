# benchmarks/results/EXP-003/ — raw artefacts for EXP-003 (CPU scaling and sweep performance)

**Status:** SKELETON — no run has executed. Record root:
[`DOCS/experiments/EXP-003-cpu-scaling-and-sweep-performance/`](../../../DOCS/experiments/EXP-003-cpu-scaling-and-sweep-performance/README.md).
...
`python -m benchmarks.benchrunner … --out benchmarks/results/EXP-003/RUN-…/`
...
run = Path("benchmarks/results/EXP-003/RUN-...")
...
run; larger arrays go to the gitignored `DOCS/test_and_benchmark_results/EXP-003/`
