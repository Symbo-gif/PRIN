# benchmarks/results/EXP-006/ — raw artefacts for EXP-006 (Temporal binding, PhaseTracker, and ablation replication)

**Status:** SKELETON — no run has executed. Record root:
[`DOCS/experiments/EXP-006-temporal-binding-phasetracker-and-ablation-replication/`](../../../DOCS/experiments/EXP-006-temporal-binding-phasetracker-and-ablation-replication/README.md).
...
`python -m benchmarks.benchrunner … --out benchmarks/results/EXP-006/RUN-…/`
...
run = Path("benchmarks/results/EXP-006/RUN-...")
...
run; larger arrays go to the gitignored `DOCS/test_and_benchmark_results/EXP-006/`
