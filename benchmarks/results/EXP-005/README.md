# benchmarks/results/EXP-005/ — raw artefacts for EXP-005 (Dynamics, chimera, and capacity replication)

**Status:** SKELETON — no run has executed. Record root:
[`DOCS/experiments/EXP-005-dynamics-chimera-and-capacity-replication/`](../../../DOCS/experiments/EXP-005-dynamics-chimera-and-capacity-replication/README.md).
...
`python -m benchmarks.benchrunner … --out benchmarks/results/EXP-005/RUN-…/`
...
run = Path("benchmarks/results/EXP-005/RUN-...")
...
run; larger arrays go to the gitignored `DOCS/test_and_benchmark_results/EXP-005/`
