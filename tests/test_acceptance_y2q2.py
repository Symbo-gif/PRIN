...
Strict port of PRINet 3.0 ``test_y2q2.py`` — imports adapted only.
"""
...
class TestTemporalCLEVR:
    ...
    def test_phase_propagation_preserves_continuity(self) -> None:
        ...
        from prin.metrics import inter_frame_phase_correlation
        from prin.nn import DiscreteDeltaThetaGamma
        from prin._torch_compat import TemporalPhasePropagator
    ...
    def test_phase_propagation_zero_carry(self) -> None:
        ...
        from prin._torch_compat import TemporalPhasePropagator, _wrap_phase
    ...
    def test_temporal_hybrid_produces_finite_logits(self) -> None:
        ...
        from prin.nn import TemporalHybridPRINet
...
class TestActiveControl:
    ...
    def test_policies_apply_max_5pct_adjustment(self) -> None:
        ...
        from prin.training_hooks import apply_lr_adjustment
    ...
    def test_active_control_trainer_creation(self) -> None:
        ...
        from prin.training_hooks import ActiveControlTrainer
...
class TestControllerRetraining:
    ...
    def test_retrain_from_telemetry_records(self) -> None:
        ...
        from prin.nn.subconscious_model import retrain_controller
...
class TestTopLevelExports:
    ...
    def test_nn_exports(self) -> None:
        ...
        from prin.nn import TemporalHybridPRINet
        from prin.training_hooks import ActiveControlTrainer, retrain_controller
    ...
    def test_top_level_exports(self) -> None:
        """Top-level prin package exports all Y2 Q2 symbols."""
        from prin import (
