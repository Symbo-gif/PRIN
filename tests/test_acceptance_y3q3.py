...
class TestFusedDiscreteStep:
    ...
    def test_pytorch_fused_step_basic(self) -> None:
        ...
        from prin.kernels import pytorch_fused_discrete_step_full
    ...
    def test_cuda_fused_kernel_available_check(self) -> None:
        ...
        from prin.kernels import cuda_fused_kernel_available
...
class TestMixedPrecision:
    ...
    def test_mixed_precision_trainer_creation(self) -> None:
        ...
        from prin.nn.hybrid import HybridPRINetV2
        from prin.training_hooks import MixedPrecisionTrainer
...
class TestCSRSparseCoupling:
    ...
    def test_csr_matrix_creation(self) -> None:
        ...
        from prin.kernels import sparse_coupling_matrix_csr
    ...
    def test_csr_coupling_step_basic(self) -> None:
        ...
        from prin.kernels import csr_coupling_step, sparse_coupling_matrix_csr
...
class TestLargeScaleOscillators:
    ...
    def test_sparse_knn_coupling_basic(self) -> None:
        ...
        from prin.kernels import build_knn_neighbors, sparse_knn_coupling_step
    ...
    def test_large_scale_system_step(self) -> None:
        ...
        from prin.simulation import LargeScaleOscillatorSystem
...
class TestAsyncPipeline:
    ...
    def test_pipeline_creation(self) -> None:
        ...
        from prin.nn.hybrid import HybridPRINetV2
        from prin.training_hooks import AsyncCPUGPUPipeline
...
class TestOscillatorPruning:
    ...
    def test_pruner_analyze(self) -> None:
        ...
        from prin.simulation import OscillatorPruner
