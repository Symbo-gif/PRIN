...
Strict port of PRINet 3.0 ``test_y2q3.py`` — imports adapted only.
"""
...
class TestHybridPRINetV2:
    ...
    def test_clevr6_convergence(self) -> None:
        ...
        _seed()
        from prin.nn import HybridPRINetV2CLEVRN
    ...
    def test_passes_existing_tests_api(self) -> None:
        ...
        from prin.nn.hybrid import HybridPRINetV2
        from prin.nn import InterleavedHybridPRINet
...
class TestFusedDiscreteKernel:
    ...
    def test_pytorch_fallback_shape(self) -> None:
        ...
        _seed()
        from prin.kernels import pytorch_fused_discrete_step
    ...
    def test_triton_matches_pytorch(self) -> None:
        ...
        from prin.kernels import pytorch_fused_discrete_step
        from prin._compat import triton_available, triton_fused_discrete_step
...
class TestOscilloBenchV2:
    ...
    def test_benchmark_script_importable(self) -> None:
        ...
        assert hasattr(mod, "run_g_architecture_sweep")
...
class TestSubconsciousLearning:
    ...
    def test_retrain_controller_from_telemetry(self) -> None:
        ...
        _seed()
        from prin.nn.subconscious_model import (
    ...
    def test_retrained_controller_valid_output(self) -> None:
        ...
        _seed()
        from prin.daemon import CONTROL_DIM, STATE_DIM
        from prin.nn.subconscious_model import SubconsciousController
...
class TestTopLevelExports:
    ...
    def test_top_level_export(self, name: str) -> None:
        """Symbol is accessible from ``import prin``."""
        import prin

        assert hasattr(prin, name), f"{name} not in prin.__all__"
